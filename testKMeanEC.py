...
df = pd.DataFrame({'Type1': [1.0, 0.0, 473.6, 0.0, 0.0, 514],
 'Type2': [3.0, 63.72, 174.0, 996.0, 524.91, 221],
 'Type3': [1.0, 0.0, 31.6, 160.92, 0.0, 351],
 'Type4': [5.0, 76.0, 21.6, 60.92, 20.0, 20],
 'Type5': [9.0, 51.0, 74.3, 10.92, 10.0, 31],
